...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<double> _hitungSelisih() async {
    final pemasukan = await _hitungTotal('pemasukan');
    final pengeluaran = await _hitungTotal('pengeluaran');
            ...
            children: [
              ...
              FutureBuilder<double>(
                ...
                builder: (context, snapshot) {
                  final selisihValue = snapshot.data ?? 0.0;
                  final isSurplus = selisihValue >= 0;
                  return Container(
